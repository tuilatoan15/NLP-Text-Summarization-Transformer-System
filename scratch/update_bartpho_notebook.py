...
# Paths
notebook_path = Path("Colab_BARTPho_VietNews_30k_3Epochs.ipynb")
output_path = Path("Colab_BARTPho_VietNews_30k_3Epochs_Checkpoint4000.ipynb")
